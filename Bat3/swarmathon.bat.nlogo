...
globals
[
  numTags ; number of tags left on the field
  robotsHome ; number of robots that have returned to base
  finished? ; rocks are fall brought back to base
  tagsXPos ; list of tag x locations
  tagsYPos ; list of tag y locations
  numberOfRocks ; total number of rocks to gather on grid
  numTicks1
]
